<div class="space-y-6 px-3 py-5 sm:px-4 sm:py-6 lg:px-6">
    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-950">
        <h1 class="text-2xl font-semibold tracking-tight text-slate-900 dark:text-white">Edit Tax Invoice</h1>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-950">
        ...
        <div class="mt-6 flex flex-wrap items-center justify-between gap-3">
            <a href="{{ route('invoice-list.general') }}" class="rounded-xl border border-slate-300 px-4 py-2 text-sm dark:border-slate-700">Back</a>
            <div class="flex flex-wrap gap-3">
                <a href="{{ route('invoice.preview', ['type' => 'general', 'invoice' => $invoice->id]) }}" target="_blank" class="rounded-xl border border-slate-300 px-4 py-2 text-sm dark:border-slate-700">Preview</a>
