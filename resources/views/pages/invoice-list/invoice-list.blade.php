<div class="space-y-6 px-3 py-5 sm:px-4 sm:py-6 lg:px-6">
    ...
    <section class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-950">
        <h2 class="mb-3 text-lg font-semibold text-slate-900 dark:text-white">{{ $this->typeLabel }} Invoices</h2>
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="4" class="px-2 py-4 text-slate-500">No {{ strtolower($this->typeLabel) }} invoices found.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
