    ...
    <section class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-950">
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm">
                ...
                <tbody>
                    @forelse ($this->proformaInvoices as $index => $invoice)
                        <tr class="border-b border-slate-50 transition hover:bg-slate-50/50 dark:border-slate-900 dark:hover:bg-slate-900/50">
                            ...
                            <td class="px-4 py-3 text-right">
                                <a href="{{ route('invoice.pdf', ['type' => 'proforma', 'invoice' => $invoice->id]) }}" class="inline-flex items-center gap-1.5 rounded-lg bg-emerald-50 px-3 py-1.5 text-xs font-bold text-emerald-700 ring-1 ring-emerald-600/20 hover:bg-emerald-100 dark:bg-emerald-500/10 dark:text-emerald-400">
                        ...
                        <tr>
                            <td colspan="7" class="px-4 py-12 text-center text-slate-500 dark:text-slate-400">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="mt-2">No proforma invoices found matching your filters.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
