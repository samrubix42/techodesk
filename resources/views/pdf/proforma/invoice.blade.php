...
<div class="page">
    ...
    <table class="meta">
        <tr>
            <td style="width:68%;">
                ...
                <p style="margin-top:8px;"><strong>Status:</strong> {{ strtoupper($invoice->status) }}</p>
            </td>
            <td style="width:32%;">
    ...
    <div class="bank">
        ...
        <p>IFSC Code: {{ $settings['bank_ifsc_code'] ?? '-' }}</p>
        <p>Branch: {{ $settings['bank_branch'] ?? '-' }}</p>
        <p style="margin-top:12px;">UPI ID: {{ $settings['bank_upi_id'] ?? '-' }}</p>
    </div>
